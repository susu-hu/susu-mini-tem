...
23. scroll/index3:商品详情页，头部导航栏为自定义的tab(fixed)+双向锚点（scroll-view实现点击tab选中对应的区域，页面滚动头部tab被选中)
#### 效果截图
...
![输入图片说明](https://images.gitee.com/uploads/images/2021/0728/172737_09522c88_8576727.png "屏幕截图.png")
#### 参与贡献
